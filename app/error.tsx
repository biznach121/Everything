  ...
  return (
    <section className="spabox-page">
      <div className="spabox-shell max-w-[760px] text-center">
        ...
        {error.digest && (
          <p className="mt-6 text-xs font-mono text-[#2f3a60]/60">
            Reference: <code className="text-[#202b54]">{error.digest}</code>
          </p>
        )}
        <div className="mt-8 flex flex-wrap items-center justify-center gap-3">
          ...
          <Link
            href="/"
            className="inline-flex min-h-14 items-center justify-center border border-[#202b54]/18 px-7 text-sm font-semibold text-[#202b54] transition-colors hover:bg-[#e0cbe1]"
          >
            Back home
          </Link>
        </div>
