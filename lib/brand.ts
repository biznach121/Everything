...
export const brand: Brand = {
  name: "Everything Nails & Spa",
  shortName: "Everything",
  microTag: "NAILS, SPA AND EVERYTHING NICE",
  description:
    "Everything Nails & Spa is a Accra beauty studio where treatments, care and calm come together under one roof.",
  ...
  contact: {
    ...
    countryCode: "GH",
    phone: "0536229394",
    phoneTel: "+233536229394",
    textPhone: "0556830507",
    textPhoneTel: "+233556830507",
    email: "hello@everything.test",
    privacyEmail: "privacy@everything.test",
    hours: "Call or text to book",
  },

  socials: [
    { label: "TikTok", href: "https://www.tiktok.com/@everything_nailsandspa", icon: "tiktok" },
  ],
  ...
  editorial: {
    ...
    notes: [
      ...
      {
        body: "At Everything Nails & Spa, self-care is not a someday luxury. It is an hour that fits into your actual life and pays you back all week.",
    ...
    images: [
      {
        ...
        alt: "Everything Nails & Spa beauty treatment detail",
      ...
      },
      {
        ...
        alt: "Everything Nails & Spa self-care treatment",
        className: "right-[5%] top-[15%] h-[255px] w-[155px] rounded-[999px]",
        sizes: "155px",
      },
      {
        src: "https://res.cloudinary.com/dcc5ggnkc/image/upload/v1780682215/yqkj1i8lrp7m9zmlze4z.jpg",
        alt: "Everything Nails & Spa beauty ritual",
      ...
      },
      {
        ...
        alt: "Everything Nails & Spa calm care moment",
        className: "right-[6%] top-[68%] h-[145px] w-[100px] rounded-[999px]",
        sizes: "100px",
      },
      {
        src: "https://res.cloudinary.com/dcc5ggnkc/image/upload/v1780682215/yqkj1i8lrp7m9zmlze4z.jpg",
        alt: "Everything Nails & Spa relaxation detail",
        className: "left-[25%] top-[75%] h-[150px] w-[102px] rounded-[999px]",
        sizes: "102px",
      },
      {
        src: "https://res.cloudinary.com/dcc5ggnkc/image/upload/v1780682215/bgkgjrchbkhtckgh9f7t.jpg",
        alt: "Everything Nails & Spa beauty and peace detail",
    ...
    items: [
      {
        ...
        imageAlt: "Everything Nails & Spa lip gloss product",
        tone: "light",
      },
      {
        name: "mint\nbeauty oil",
        ...
        imageAlt: "Everything Nails & Spa mint oil product",
        tone: "olive",
      },
      {
        name: "brush\nessentials",
        ...
        imageAlt: "Everything Nails & Spa makeup brush set",
        tone: "light",
      },
      {
        name: "smooth\nfoundation",
        ...
        imageAlt: "Everything Nails & Spa foundation product",
        tone: "olive",
      },
    ],
  },
  ...
  media: {
    title: "media",
    ctaLabel: "Follow",
    ctaHref: "https://www.tiktok.com/@everything_nailsandspa",
    images: [
      {
        src: "https://res.cloudinary.com/dzykdnbvb/video/upload/v1783489769/stage4/spa_everythingnailsandspa/tiktok_0.mp4",
        alt: "Everything Nails & Spa treatment video",
        position: "center",
      },
      {
        src: "https://res.cloudinary.com/dzykdnbvb/video/upload/v1783489773/stage4/spa_everythingnailsandspa/tiktok_1.mp4",
        alt: "Everything Nails & Spa treatment video",
        position: "center",
      },
      {
        src: "https://res.cloudinary.com/dcc5ggnkc/video/upload/v1780581429/hptukehgmrufp33qyd5e.mp4",
        alt: "Everything Nails & Spa salon media video",
        position: "center",
      },
      {
        src: "https://res.cloudinary.com/dcc5ggnkc/video/upload/v1780581430/gse4jxivlcejlrtq3fjk.mp4",
        alt: "Everything Nails & Spa self-care media video",
        position: "center",
      },
      {
        src: "https://res.cloudinary.com/dcc5ggnkc/video/upload/v1780581409/pq6ritvfxvxkhsjqkct4.mp4",
        alt: "Everything Nails & Spa studio media video",
        position: "center",
      },
    ],
  },
  ...
  about: {
    eyebrow: "About Everything Nails & Spa",
    title: "Your sanctuary\nof beauty and peace.",
    paragraphs: [
      "Everything Nails & Spa is a curated beauty and self-care space in Accra, created for the moments when you want to feel polished, calm, and cared for without rushing through the process.",
    ...
    sections: [
      ...
      {
        heading: "Visit",
        body: "Find us in Accra. Use the Location page for the exact Google Maps pin, or call 0536229394 and text 0556830507 for booking help.",
      },
    ],
  },
  ...
  faq: {
    ...
    sections: [
      {
        ...
        items: [
          { q: "How do I book?", a: "Use the Book page, call 0536229394, text 0556830507, or message @everything_nailsandspa on Instagram." },
          ...
          { q: "Where are you located?", a: "Everything Nails & Spa is in Accra. The Location page has the exact Google Maps pin." },
        ],
      },
      {
        title: "Treatments",
    ...
    contactEmail: "hello@everything.test",
  },
  ...
  terms: {
    ...
    sections: [
      { heading: "1. Who we are", body: "Everything Nails & Spa (\"we\", \"us\") is a beauty and self-care business in Accra, Ghana. By booking a service or buying a product, you agree to these terms." },
  ...
  privacy: {
    ...
    sections: [
      ...
      { heading: "Your rights", body: "Under the Ghana Data Protection Act, 2012 (Act 843), you can access, correct, or delete your data. Email privacy@everything.test." },
  ...
  shipping: {
    ...
    sections: [
      ...
      { heading: "Location", body: "Everything Nails & Spa is in Accra. Visit the Location page for the exact Google Maps pin." },
  ...
  accessibility: {
    ...
    sections: [
      ...
      { heading: "Reporting issues", body: "Email accessibility@everything.test, call, or text the studio. We respond within a business day." },
    ],
  },

  account: {
    loginEyebrow: "Welcome back",
    loginTitle: "Sign in to Everything Nails & Spa",
  ...
  contactPage: {
    ...
    directLines: [
      { label: "Call", value: "0536229394", href: "tel:+233536229394" },
      { label: "Text", value: "0556830507", href: "sms:+233556830507" },
      { label: "Instagram", value: "@everything_nailsandspa", href: "https://www.tiktok.com/@everything_nailsandspa" },
    ],
  },
  ...
  footer: {
    logoUrl: "https://res.cloudinary.com/dzykdnbvb/image/upload/v1783489754/stage4/spa_everythingnailsandspa/avatar.jpg",
    blurb:
      "Everything Nails & Spa in Accra — nails, spa and everything nice.",
    sitemap: [
      {
        title: "Visit",
        links: [
          ...
          { label: "Location", href: "/location" },
          { label: "Instagram", href: "https://www.tiktok.com/@everything_nailsandspa" },
        ],
      },
      {
        title: "Studio",
      ...
      },
      {
        ...
        links: [
          ...
          { label: "Call 0536229394", href: "tel:+233536229394" },
          { label: "Text 0556830507", href: "sms:+233556830507" },
        ],
      },
      {
        title: "Account",
  ...
  llms: {
    summary:
      "Everything Nails & Spa — beauty and self-care in Accra. Lashes, brows, nails, pedicure, waxing, piercing, facials, massage, and beauty products. Booking via website, call, text, or Instagram.",
  },
