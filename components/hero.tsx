...
export function Hero({
  ...
  return (
    <section className="spa-video-hero relative isolate h-[95svh] min-h-[620px] overflow-hidden rounded-b-[28px] bg-[#47347d] text-white lg:rounded-b-[36px]">
      {heroVideos.length > 0 ? (
        ...
        <div className="absolute inset-0 -z-20 bg-[#4d3d8e]" />
      )}
      <div className="absolute inset-0 -z-10 bg-[linear-gradient(90deg,rgba(43, 30, 84,0.58),rgba(53, 38, 117,0.22)_43%,rgba(45, 34, 85,0.34)),linear-gradient(0deg,rgba(23, 18, 43,0.18),rgba(23, 18, 43,0.08))]" />
