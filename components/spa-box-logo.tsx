...
const LOGO_URL =
  "https://res.cloudinary.com/dzykdnbvb/raw/upload/v1783489753/stage4/spa_everythingnailsandspa/logo.svg";
...
export function SpaBoxLogo({ className = "", compact = false, tone = "light" }: SpaBoxLogoProps) {
  ...
  if (REAL_LOGO) {
    ...
    return (
      <span className={["relative inline-block", sizeClass, className].join(" ")} aria-label="Everything Nails & Spa - Nails, spa and everything nice">
        <Image
          src={src}
          alt="Everything Nails & Spa - Nails, spa and everything nice"
          fill
